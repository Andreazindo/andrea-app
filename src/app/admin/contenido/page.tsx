...
const summaryClass = "text-sm font-semibold uppercase tracking-wide text-[#0D3B36] cursor-pointer select-none";
...
export default async function ContenidoAdminPage({
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-10 space-y-10">
      ...
      <form action={updateSiteContentAction} className="space-y-4">
        <details className={sectionClass}>
          <summary className={summaryClass}>Inicio</summary>
        ...
        <details className={sectionClass}>
          <summary className={summaryClass}>Tienda Wellness</summary>
          <div className="mt-4">
        ...
        <details className={sectionClass}>
          <summary className={summaryClass}>Evolución Personal</summary>
          <div className="mt-4">
        ...
        <details className={sectionClass}>
          <summary className={summaryClass}>Contacto</summary>
          <div className="mt-4 space-y-4">
            <div>
      ...
      <details className={sectionClass}>
        <summary className={summaryClass}>
          Puntos de Venta <span className="ml-1 text-xs font-normal normal-case text-[#1A1A1A]/50">({salesPoints.length})</span>
        </summary>
        <div className="mt-4 space-y-4">
          {salesPoints.map((point) => (
            <div key={point.id} className="rounded-lg border border-[#9CBA9D]/40 p-4 space-y-4">
          ...
          <details className="rounded-lg border border-[#9CBA9D]/40 p-4">
