...
import type { Brand, Product, ProductVariant, KitComponent } from "@/generated/prisma/client";
...
export default async function ProductPage({
  ...
  if (brand.code === "ZINDO") {
    return <ZindoProductPage brand={brand} product={product} variantsWithStock={variantsWithStock} />;
  }
...
function ZindoProductPage({
  ...
  brand: Brand;
  product: Product;
  variantsWithStock: VariantWithStock[];
}) {
  return (
    <div className={zindoFontVars} style={{ backgroundColor: zindoColors.ivory, minHeight: "100%" }}>
      <div className="flex items-center justify-center py-8" style={{ backgroundColor: zindoColors.ink }}>
        <ZindoLogo color={zindoColors.ivory} className="w-32" />
      </div>
